    ...
    <div className="w-full max-w-md">
      <div className="bg-cream-50 border border-ink/5 rounded-3xl p-8 lg:p-10 shadow-sm">
        ...
        <p className="mt-6 text-xs text-ink/40 text-center">
          Credenciais padrão definidas pelo seed:
          <br />
          <code className="bg-ink/5 px-2 py-0.5 rounded">admin@clubevantagem.com</code> /{' '}
          <code className="bg-ink/5 px-2 py-0.5 rounded">admin123</code>
        </p>
      </div>
    </div>
  );
