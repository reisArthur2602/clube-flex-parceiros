            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-10">
                ...
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12">
                    ...
                    <p className="text-ink/70 max-w-md text-lg">
                        ...
                        <br />
                        <span className="font-medium">{partners.length}</span> parceiros disponíveis
                        agora.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-[1fr,auto] gap-3 mb-6">
                    ...
                    <select
                        value={sortBy}
                        onChange={(e) =>
                            setSortBy(e.target.value as 'featured' | 'discount' | 'name')
                        }
...
function PartnerCard({ partner, onOpen }: { partner: PartnerView; onOpen: () => void }) {
    return (
        <button
            onClick={onOpen}
        ...
        >
            ...
            <h3 className="display text-2xl text-ink mb-2 group-hover:text-coral transition-colors">
                {partner.name}
            </h3>
...
function PartnerModal({ partner, onClose }: { partner: PartnerView; onClose: () => void }) {
    return (
        <div
