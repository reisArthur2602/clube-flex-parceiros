export function HowItWorks() {
    ...
    return (
        <section
            id="como-funciona"
            className="bg-cream-200/50 py-24 lg:py-32 border-y border-ink/5"
        >
                        ...
                        <div key={s.step} className="relative">
                            ...
                            <div className="bg-cream-50 rounded-2xl p-8 h-full border border-ink/5">
                                <div className="flex items-baseline gap-3 mb-6">
                                    <span className="display text-6xl text-coral">{s.step}</span>
                                    <span className="display-italic text-xl text-coral">/04</span>
                                </div>
