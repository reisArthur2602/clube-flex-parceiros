        ...
        <div>
            <div className="grid grid-cols-1 md:grid-cols-[1fr,auto] gap-3 mb-6">
                ...
                <select
                    value={filter}
                    onChange={(e) =>
                        setFilter(e.target.value as 'all' | 'active' | 'inactive' | 'featured')
                    }
                    ...
                    <tbody>
                        {filtered.length === 0 ? (
                            <tr>
                                <td
                                    colSpan={5}
                                    className="py-12 text-center text-ink/40 display-italic text-2xl"
                                >
                                    Nada encontrado
                                </td>
                            </tr>
                            ...
                            filtered.map((p) => (
                                ...
                                >
                                    ...
                                    <td className="py-2 md:py-4 px-5">
                                        <span className="display-italic text-coral text-xl">
                                            {p.discount}
                                        </span>
                                    </td>
                                    <td className="py-2 md:py-4 px-5">
                                        <button
                                            ...
                                            className={`text-xs px-3 py-1 rounded-full transition-colors ${
                                                p.isActive
                                                    ? 'bg-forest/10 text-coral hover:bg-forest/20'
